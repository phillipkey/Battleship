...
export const SHIPSET1: Ship[] = [
    { id: 1, name: "Aircraft Carrier", health: 5, symbol: "A", position: [ [3,2], [3,3], [3,4], [3,5], [3,6] ] },
    { id: 2, name: "Battleship", health: 4, symbol: "B", position: [ [6,5], [7,5], [8,5], [9,5] ] },
    { id: 3, name: "Cruiser", health: 3, symbol: "C", position: [ [1,2], [1,3], [1,4] ] },
    { id: 4, name: "Submarine", health: 3, symbol: "S", position: [ [4,9], [5,9], [6,9] ] },
    { id: 5, name: "Destroyer", health: 2, symbol: "D", position: [ [5,3], [6,3] ] }
]
